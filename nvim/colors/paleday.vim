...
" Vim Color File
" Name:       paleday.vim
" Maintainer: https://github.com/drewtempelmeyer/paleday.vim
...
let s:overrides = get(g:, "paleday_color_overrides", {})
...
let s:colors = {
      ...
      \ "black": get(s:overrides, "black", { "gui": "#fff", "cterm": "235", "cterm16": "0" }),
      ...
      \ "cursor_grey": get(s:overrides, "cursor_grey", { "gui": "#4E5579", "cterm": "236", "cterm16": "8" }),
      \ "visual_grey": get(s:overrides, "visual_grey", { "gui": "#4E5579", "cterm": "237", "cterm16": "15" }),
...
if !exists("g:paleday_termcolors")
  let g:paleday_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:paleday_terminal_italics")
  let g:paleday_terminal_italics = 0
endif

" This function is based on one from FlatColor: https://github.com/MaxSt/FlatColor/
" Which in turn was based on one found in hemisu: https://github.com/noahfrederick/vim-hemisu/
function! s:h(group, style)
  if g:paleday_terminal_italics == 0
...
function! paleday#set_highlight(group, style)
...
call s:h("rubyTestMacro", { "fg": s:purple })
...
if has("nvim")
  let g:terminal_color_0 =  s:white.gui
